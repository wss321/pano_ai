...
def fine_tune_inceptionV3(num_class=5, input_shape=(256, 256, 3), norm_rate=0.0):
    ...
    x = Dense(256, activation='relu', kernel_regularizer=regularizers.l2(norm_rate))(x)
...
def fine_tune_VGG19(num_class=5, input_shape=(256, 256, 3), norm_rate=0.0):
    # create the base pre-trained model
...
def fine_tune_densenet121(num_class=5, input_shape=(256, 256, 3), norm_rate=0.0):
